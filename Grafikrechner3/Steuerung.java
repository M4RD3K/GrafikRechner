    ...
    */
	 ...
	 */
	 public void findeNullstelle(double x) {
	  ...
	  /**
	   * Berechnet den Y-Wert der Ableiteung fuer einen spezifischen X-Wert.
	   * @param x xwert
	 ...
	 * @param konstante ist die vorher bestimme Konstante aus der Methode bestimmeKonstanteDesProduktes
